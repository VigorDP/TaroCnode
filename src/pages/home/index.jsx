    ...
    return (
      <View className={styles.home}>
        <AtTabs current={this.state.current} tabList={tabList} onClick={this.handleClick.bind(this)}>
          <AtTabsPane current={this.state.current} index={0} className={styles.panel}>
            <AllTab ownProps={{ tab: 'all' }} />
          </AtTabsPane>
          <AtTabsPane current={this.state.current} index={1} className={styles.panel}>
            <GoodTab ownProps={{ tab: 'good' }} />
          </AtTabsPane>
          <AtTabsPane current={this.state.current} index={2} className={styles.panel}>
            <ShareTab ownProps={{ tab: 'share' }} />
          </AtTabsPane>
          <AtTabsPane current={this.state.current} index={3} className={styles.panel}>
            <AskTab ownProps={{ tab: 'ask' }} />
          </AtTabsPane>
          <AtTabsPane current={this.state.current} index={4} className={styles.panel}>
